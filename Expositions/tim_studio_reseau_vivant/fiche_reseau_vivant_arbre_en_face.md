...
![affiche de l'exposition](media/reseau_vivant_affiche.png)
...
Cette semaine, je me suis procuré un billet pour le jour 1 de Osheaga. Je ne suis pas quelqu'un qui va à des festivals habituellement, mais je ne pouvais pas manqué l'un des artistes sur le lineup: Twenty One Pilots. Ce sera la cinquième fois que je vais les voir en concert, mais cette fois dans un atmophère un peu différent. Je les ai déjà vu dans un concert extérieur lors de leur dernière tournée à Toronto, mais se sera la première fois que je vais les voir lors d'un concert 100% admission générale. Je vais peut-être avoir la chance de les voirs plus près cette fois-ci! J'y vais avec mon amie Mari, ce sera la quatrième fois que nous allons les voir ensemble. Depuis 2019 notre amitié a bien évolué grâce à cet artiste. On espère entendre des chansons que nous avons pas encore eu la chance de voir lors des précédents concerts. j'aimerais bien voir holding on to you si possible, ils ont enlevé ce classique de leur setlist la tournée précédente. Et bien sûr j'aimerais entendre leur dernier single qui fonctionne bien sur les réseaux sociaux.
